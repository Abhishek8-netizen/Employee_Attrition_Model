...
def bar_chart(df):
    ...
    ax.set_title('1. Average Monthly Income by Attrition Status')
...
def histogram(df):
    ...
    ax.set_title('3. Histogram of Employee Ages')
    ax.set_xlabel('Age')
...
def boxplot(df):
    ...
    ax.set_title('4. Box Plot: Years At Company by Attrition Status')
    ax.set_xlabel('Attrition Status')
...
def pie(df):
    ...
    ax.set_title('5. Proportion of Employee Attrition')
    return fig
...
def barPlot(df):
    ...
    ax.set_title('6. Attrition Rate by Job Role')
...
def line_plot(df):
    ...
    ax.set_title('10. Attrition Rate vs. Distance From Home (3-point Rolling Average)')
...
def heatmap(df):
    ...
    plt.title('8. Heatmap: Correlation Matrix of Key Features (vs. Attrition)')

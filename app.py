...
tab1,tab2,tab3,tab4,tab5,tab6,tab7,tab8 = st.tabs(["Upload dataset","Cleaned dataset","Summary statistics","Visualizations",
                                         "Training the ML Models","Evaluation","Insights","Prediction"])
